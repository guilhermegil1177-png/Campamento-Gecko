...
import { Calendar, BookOpen, Settings, LogOut, Plus, ChevronRight, Clock, CheckCircle2, Users, Eye, Bell, Megaphone, AlertTriangle, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-5 space-y-4 max-w-2xl pb-24">
        ...
        <div className="animate-slide-up">
          ...
          <span className="gecko-badge bg-primary/15 text-primary border border-primary/30 mt-2 inline-block">
            {roleLabel}
          </span>
        </div>
        ...
        <div className="animate-slide-up gecko-card" style={{ animationDelay: '80ms' }}>
          ...
          {showAlertInput && (
            <div className="flex gap-2 mb-3">
              ...
              <button
                onClick={sendAlert}
                className="gecko-btn-primary px-4 py-2 rounded-xl text-sm"
              >
                Enviar
              </button>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                <button
                  ...
                  className="w-full gecko-card flex items-center justify-center gap-2 text-sm text-primary hover:border-primary/50 transition-all"
                >
              ...
              return (
                <div key={m.id} className="gecko-card">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className={`gecko-badge border text-xs font-semibold ${
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1 h-1.5 bg-muted rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all duration-500 ${allDone ? 'bg-green-500' : noneDone ? 'bg-red-500' : 'bg-yellow-400'}`}
                        style={{ width: pct + '%' }}
                      />
                    </div>
        ...
        <div className="animate-slide-up grid grid-cols-2 gap-3" style={{ animationDelay: '150ms' }}>
          {[
            ...
            <button
              ...
              className={`gecko-card border flex items-center gap-3 hover:scale-[1.02] transition-all text-left ${color}`}
            >
